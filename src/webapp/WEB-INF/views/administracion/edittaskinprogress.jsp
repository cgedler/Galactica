...
<title>Edit Tasks in progress</title>
</head>
<body>
...
<div class="container">
<a href="${pageContext.request.contextPath}/administracion/mytasksinprogress" type="button" class="btn btn-outline-dark btn-sm" data-toggle="tooltip" data-placement="top" title="Regresar al Listado"><i class="bi-arrow-bar-left"></i></a>
<h2>Editar Tarea: <span style="color:red;"> ${req.id} </span> </h2>
<form:form action="keeptaskinprogress" modelAttribute="req" method="POST">
