...
<h2>Editar el Usuario: <span style="color:red;"> ${user.username} </span> </h2>
<form:form action="keep" modelAttribute="user" method="POST">
...
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="activo"><form:checkbox path="enabled" /> Activo </label>
	</div>
</div>
<hr class="mb-4">
<div class="row">
...
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="activo"><form:checkbox path="authority" value="ROLE_usuario"/> Usuario</label>
	</div>
</div>
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="activo"><form:checkbox path="authority" value="ROLE_administrador"/> Administrador</label>
	</div>
</div>
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="activo"><form:checkbox path="authority" value="ROLE_contador"/> Contador</label>
	</div>
</div>
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="activo"><form:checkbox path="authority" value="ROLE_rrhh"/> RRHH</label>
	</div>
</div>
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="activo"><form:checkbox path="authority" value="ROLE_sistema"/> Sistemas</label>
	</div>
</div>
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="activo"><form:checkbox path="authority" value="ROLE_tesorero"/> Tesorero</label>
	</div>
</div>
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="activo"><form:checkbox path="authority" value="ROLE_usuarios"/> Usuarios</label>
	</div>
</div>
