...
<div class="container">
<a href="${pageContext.request.contextPath}/calificaciones/list" type="button" class="btn btn-outline-dark btn-sm" data-toggle="tooltip" data-placement="top" title="Regresar al Listado"><i class="bi-arrow-bar-left"></i></a>
<h2>Editar Calificación: <span style="color:red;"> ${qualification.id} </span> </h2>
<form:form action="keep" modelAttribute="qualification" method="POST">
<form:hidden path="id" value="${qualification.id}"/>
<div class="row">
	<div class="col-md-6 mb-3">
		<label for="qualification">Calificación:</label>
		<form:input path="qualification" class="form-control" type="text"/>
	</div>
</div>
