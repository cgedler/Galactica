...
public interface TaskDAO {
	...
	/**
	   ...
	   * @return a list of all the Tasks.
	   */
    public List<Task> getTasksSelect();
    
    /**
     * Get Task as Optional by id.
     *
     * @param id unique identifier of the Task.
     * @return an optional with task if a Task with unique identifier <code>id</code> exists.
     */
     ...
     * Add a Task.
     *
     * @param theTask the Task to be added.
     */
     ...
     * Update a Task.
     *
     * @param theTask the Task to be updated.
     */
