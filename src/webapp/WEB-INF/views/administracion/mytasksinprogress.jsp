...
<title>My Tasks in progress</title>
</head>
<body>
...
<tbody>
<c:forEach var="ListItem" items="${listTasksInProgress}">
	<!-- Link para Actualizar-->
	<c:url var="linkActualizar" value="/administracion/edittaskinprogress">
