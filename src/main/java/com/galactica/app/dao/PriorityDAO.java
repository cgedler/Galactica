...
public interface PriorityDAO {
	...
	/**
	   * Get all Prioritys.
	   *
	   * @return a list of all the Priority.
	   */
	public List<Priority> getPrioritys();
    
	/**
     * Get Priority as Optional by id.
     *
     * @param id unique identifier of the Priority.
     * @return an optional with priority if a Priority with unique identifier <code>id</code> exists.
     */
     ...
     * Add a Priority.
     *
     * @param thePriority the Priority to be added.
     */
     ...
     * Update a Priority.
     *
     * @param thePriority the Priority to be updated.
     */
     ...
     * Delete a Priority.
     *
     * @param id unique identifier of the Priority to be deleted.
     */
