...
<h2>Editar Prioridad: <span style="color:red;"> ${priority.id} </span> </h2>
<form:form action="keep" modelAttribute="priority" method="POST">
<form:hidden path="id" value="${priority.id}"/>
<div class="row">
