...
<c:forEach var="ItemTemp" items="${listado}">
	<!-- Link para Detalles -->
	<c:url var="linkDetalle" value="/empleados/detail">
		<c:param name="id" value="${ItemTemp.id}"></c:param>
	</c:url>
	<!-- Link para Actualizar -->
	<c:url var="linkActualizar" value="/empleados/edit">
		<c:param name="id" value="${ItemTemp.id}"></c:param>
	</c:url>
	<!-- Link para Eliminar -->
	<c:url var="linkEliminar" value="/empleados/eliminate">
		<c:param name="id" value="${ItemTemp.id}"></c:param>
	</c:url>
    <tr>
    	<td>${ItemTemp.id}</td>
        <td>${ItemTemp.name}</td>
        <td>${ItemTemp.lastname}</td>
        <td>${ItemTemp.department}</td>
        <td class="text-center">
        <form:form action="${linkEliminar}" modelAttribute="employee" method="POST">
