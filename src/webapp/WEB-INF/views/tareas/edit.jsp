...
<div class="container">
<a href="${pageContext.request.contextPath}/tareas/list" type="button" class="btn btn-outline-dark btn-sm" data-toggle="tooltip" data-placement="top" title="Regresar al Listado"><i class="bi-arrow-bar-left"></i></a>
<h2>Editar Tarea: <span style="color:red;"> ${task.id} </span> </h2>
<form:form action="keep" modelAttribute="task" method="POST">
